...
line('</p>');
line('<p align="center">');
line('  <!-- Custom animated snake (renders immediately); the "Generate Snake" workflow can swap this for the contribution-mapped version on the `output` branch. -->');
line('  <img src="'+A+'snake.svg" alt="Snake Animation"/>');
line('</p>');
line('');
line('---');
line('');
